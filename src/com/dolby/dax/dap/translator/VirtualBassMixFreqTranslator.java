...
public class VirtualBassMixFreqTranslator implements Translator
{
    static final Parameter[] srcParams;
    
    static {
        srcParams = new Parameter[] { Parameter.virtual_bass_mix_freq_low, Parameter.virtual_bass_mix_freq_high };
    }
    ...
    public void dap2Translate(final SetParamCommand setParamCommand, final ParameterValues parameterValues, final Endpoint endpoint) {
        setParamCommand.add(DapParameter.DAP2_VBMF, new int[][] { parameterValues.get(VirtualBassMixFreqTranslator.srcParams[0]), parameterValues.get(VirtualBassMixFreqTranslator.srcParams[1]) });
    }
    
    @Override
    public Parameter[] srcParams() {
        return VirtualBassMixFreqTranslator.srcParams;
    }
}
